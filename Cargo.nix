...
# See https://github.com/kolloch/crate2nix for more info.
{
  ...
  internal = rec {
    ...
    crates = {
      ...
      "distributed-topic-tracker" = rec {
        crateName = "distributed-topic-tracker";
        version = "0.1.5";
        edition = "2024";
        sha256 = "0qjmpa8zb5ignplpz9f4iqdp5qs31y6fv10lr19mh53ggnj2hzh8";
        libName = "distributed_topic_tracker";
        authors = [
          "Zacharias Boehler <rustonbsd@mailfence.com>"
        ];
        dependencies = [
          {
            name = "anyhow";
      ...
      "ed25519-dalek-hpke" = rec {
        crateName = "ed25519-dalek-hpke";
        version = "0.0.4";
        edition = "2021";
        sha256 = "1q4ah425lxqqjw8qyi0ni4ix0brl4679v9b73v9saf1wfpk83i7a";
        libName = "ed25519_dalek_hpke";
        authors = [
          "Zacharias Boehler <rustonbsd@mailfence.com>"
        ];
        dependencies = [
      ...
      "elliptic-curve" = rec {
        ...
        resolvedDefaultFeatures = ["arithmetic" "digest" "ecdh" "ff" "group" "hazmat" "sec1"];
      };
      ...
      "hpke" = rec {
        ...
        version = "0.13.0";
        edition = "2021";
        sha256 = "13qck1h8ir4d5cjl9xs0xgp8icvir6q71jaiv2i1y6nxk6v1cpgn";
        authors = [
          "Michael Rosenberg <michael@mrosenberg.pub>"
        ];
        dependencies = [
      ...
      "mainline" = rec {
        ...
        version = "5.4.0";
        edition = "2021";
        sha256 = "0j62zl2540kvfp0lhdkkd17052v0kdmb6fd2q46jgdsjz80v0n62";
        authors = [
          "nuh.dev"
        ];
        dependencies = [
        ...
        resolvedDefaultFeatures = ["async" "default" "full" "node"];
      };
      "matchers" = rec {
        crateName = "matchers";
        version = "0.1.0";
      ...
      "reqwest" = rec {
        ...
        resolvedDefaultFeatures = ["__rustls" "__rustls-ring" "__tls" "rustls-tls" "rustls-tls-webpki-roots" "rustls-tls-webpki-roots-no-provider" "stream"];
      };
      "resolv-conf" = rec {
      ...
      "room_101" = rec {
        ...
        dependencies = [
          ...
          }
          {
            ...
            packageId = "distributed-topic-tracker";
          }
          {
            name = "ed25519-dalek";
            packageId = "ed25519-dalek";
      ...
      "sec1" = rec {
        ...
        resolvedDefaultFeatures = ["default" "der" "point" "subtle" "zeroize"];
      };
      "secrecy" = rec {
        crateName = "secrecy";
        version = "0.10.3";
      ...
      "serde_bencode" = rec {
        ...
        version = "0.2.4";
        edition = "2018";
        sha256 = "0gj17p1w5hyi69fngv55dai4nb4fmdij76gqwyb9if9qfixzq3d7";
        authors = [
          "Toby Padilla <tobypadilla@gmail.com>"
          "Nautilus Cyberneering <info@nautilus-cyberneering.de>"
        ];
        dependencies = [
          {
            name = "serde";
      ...
      "time" = rec {
        ...
        resolvedDefaultFeatures = ["alloc" "default" "std" "wasm-bindgen"];
      };
      "time-core" = rec {
        crateName = "time-core";
        version = "0.1.4";
      ...
      "winapi" = rec {
        ...
        resolvedDefaultFeatures = ["basetsd" "consoleapi" "dbghelp" "errhandlingapi" "fileapi" "handleapi" "libloaderapi" "minwindef" "processenv" "processthreadsapi" "winerror" "winnt"];
      };
      ...
      "windows-sys 0.59.0" = rec {
        ...
        resolvedDefaultFeatures = ["Wdk" "Wdk_Foundation" "Wdk_Storage" "Wdk_Storage_FileSystem" "Wdk_System" "Wdk_System_IO" "Win32" "Win32_Foundation" "Win32_NetworkManagement" "Win32_NetworkManagement_IpHelper" "Win32_NetworkManagement_Ndis" "Win32_Networking" "Win32_Networking_WinSock" "Win32_Security" "Win32_Storage" "Win32_Storage_FileSystem" "Win32_System" "Win32_System_Com" "Win32_System_Console" "Win32_System_IO" "Win32_System_Pipes" "Win32_System_SystemInformation" "Win32_System_SystemServices" "Win32_System_Threading" "Win32_System_WindowsProgramming" "Win32_UI" "Win32_UI_Shell" "default"];
      };
